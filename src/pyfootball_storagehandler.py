...
class RfaFileStorageHandler():
    """
    The RfaFileStorageHandler create a text file and save required access
...
class RfaStorageHandler():
    """
    RfaStorageHandler class is used to store temperary token.

        The RfaStorageHandler object will be temperarly store the
